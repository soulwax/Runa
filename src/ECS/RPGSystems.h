...
RUNA_API void renderDamageNumbers(entt::registry& registry, SpriteBatch& batch, Font& font, Camera& camera);

// ===== UI Rendering =====

RUNA_API void renderHealthBars(entt::registry& registry, SpriteBatch& batch, Camera& camera);
RUNA_API void renderPlayerUI(entt::registry& registry, SpriteBatch& batch, Font& font, int screenWidth, int screenHeight);
