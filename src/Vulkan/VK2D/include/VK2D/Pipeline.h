// File: src/Vulkan2D/VK2D/include/VK2D/Pipeline.h
...
///
/// Several things are set to dynamic state and will be ignored, hence this
/// asking for only 3 create infos when in reality there are many more. For a
/// complete list of dynamic state,
///
///  + Viewports
...
vk2dPipelineCreate(VK2DLogicalDevice dev, VkRenderPass renderPass,
                   ...
                   uint32_t fragSize, VkDescriptorSetLayout *setLayout,
...
/// \brief Grabs a pipeline given a blend mode, returning the default one if
/// blend mode generation is disabled
...
/// \return Returns a unique id from this pipe and blend mode, guaranteed to be
