...
Each application installed on iPhone resides in a Runa folder which includes its own Application Home directory.  Your application may not access files outside this directory.
