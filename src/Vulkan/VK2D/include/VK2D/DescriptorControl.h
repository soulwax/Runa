// File: src/Vulkan2D/VK2D/include/VK2D/DescriptorControl.h
...
/// \param sampler Location of the sampler or VK2D_NO_LOCATION if unused
/// (binding)
...
/// \brief Creates, updates, and returns a descriptor set ready to be bound to a
/// command buffer
/// \param descCon Descriptor controller to pull the set from
/// \param buffer Buffer to bind to the descriptor set
/// \return Returns a new descriptor set ready to be bound to a command buffer
/// (valid until vk2dDescConReset is called)
...
/// command buffer
/// \param descCon Descriptor controller to pull the set from
/// \param tex Texture to bind to the descriptor set (namely the sampler and
/// image view)
/// \return Returns a new descriptor set ready to be bound to a command buffer
/// (valid until vk2dDescConReset is called)
...
/// \brief Resets all pools in a descriptor controller (basically deletes all
/// active sets so new ones can be allocated)
