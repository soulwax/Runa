...
/// \brief Adds an edge to a shadow environment's current object, use this on
/// wall edges
...
///
/// You may call this from another thread so long as you do not call
/// vk2DShadowEnvironmentFlushVBO at the same time (ie, set up all your edges in
/// the other thread and once you know that thread is done adding edges call
/// vk2DShadowEnvironmentFlushVBO).
void vk2dShadowEnvironmentAddEdge(VK2DShadowEnvironment shadowEnvironment,
                                  float x1, float y1, float x2, float y2);

/// \brief Removes all edges from the shadow environment's cache in case you
/// want to change the edges
/// \param shadowEnvironment Shadow environment to reset
/// \warning This invalidates all objects previously got from
/// vk2dShadowEnvironmentAddObject
void vk2dShadowEnvironmentResetEdges(VK2DShadowEnvironment shadowEnvironment);

/// \brief Flushes the edges present in the environment to a VBO that can be
/// drawn to screen
/// \param shadowEnvironment Shadow environment to flush
/// \warning This function has heavy overhead and should not be called every
/// frame.
