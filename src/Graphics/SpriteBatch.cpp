...
namespace Runa
{
    ...
    void SpriteBatch::createPipeline()
    {
        ...
        LOG_INFO("SpriteBatch graphics pipeline created successfully with alpha blending");
    }
    ...
    void SpriteBatch::end()
    {
        ...
        for (const auto &call : m_drawCalls)
        {
            ...
            allVertices.push_back({x1, y1, u1, v1, call.r, call.g, call.b, call.a}); // Top-left
            allVertices.push_back({x2, y1, u2, v1, call.r, call.g, call.b, call.a}); // Top-right
            allVertices.push_back({x1, y2, u1, v2, call.r, call.g, call.b, call.a}); // Bottom-left
            allVertices.push_back({x2, y1, u2, v1, call.r, call.g, call.b, call.a}); // Top-right
            allVertices.push_back({x2, y2, u2, v2, call.r, call.g, call.b, call.a}); // Bottom-right
            allVertices.push_back({x1, y2, u1, v2, call.r, call.g, call.b, call.a}); // Bottom-left
        }
