...
static const char *DEBUG_EXTENSIONS[] = {VK_KHR_SWAPCHAIN_EXTENSION_NAME};
...
static const char *BASE_EXTENSIONS[] = {VK_KHR_SWAPCHAIN_EXTENSION_NAME};
...
VkInstanceCreateInfo vk2dInitInstanceCreateInfo(VkApplicationInfo *appInfo,
                                                const char **layers,
                                                int layerCount,
...
VkDeviceQueueCreateInfo vk2dInitDeviceQueueCreateInfo(uint32_t queueFamilyIndex,
                                                      float *priority) {
...
VkDeviceCreateInfo vk2dInitDeviceCreateInfo(VkDeviceQueueCreateInfo *info,
                                            uint32_t size,
...
vk2dInitCommandPoolCreateInfo(uint32_t queueFamilyIndex,
...
vk2dInitCommandBufferAllocateInfo(VkCommandPool pool, uint32_t count) {
...
VkDebugReportCallbackCreateInfoEXT vk2dInitDebugReportCallbackCreateInfoEXT(
...
VkCommandBufferBeginInfo vk2dInitCommandBufferBeginInfo(
...
VkSubmitInfo vk2dInitSubmitInfo(VkCommandBuffer *commandBufferVector,
                                uint32_t commandBufferCount,
                                VkSemaphore *signalSemaphoreVector,
                                uint32_t signalSemaphoreCount,
                                VkSemaphore *waitSemaphoreVector,
...
vk2dInitSemaphoreCreateInfo(VkSemaphoreCreateFlags flags) {
...
VkSwapchainCreateInfoKHR vk2dInitSwapchainCreateInfoKHR(
    VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR capabilities,
    VkSurfaceFormatKHR format, uint32_t surfaceWidth, uint32_t surfaceHeight,
...
VkImageViewCreateInfo vk2dInitImageViewCreateInfo(VkImage image,
                                                  VkFormat format,
...
VkImageCreateInfo vk2dInitImageCreateInfo(uint32_t imageWidth,
                                          uint32_t imageHeight, VkFormat format,
...
VkMemoryAllocateInfo vk2dInitMemoryAllocateInfo(uint32_t size,
                                                uint32_t memoryType) {
...
VkRenderPassCreateInfo vk2dInitRenderPassCreateInfo(
    VkAttachmentDescription *attachments, uint32_t attachCount,
    VkSubpassDescription *subpasses, uint32_t subpassCount,
    VkSubpassDependency *deps, uint32_t depCount) {
...
VkFramebufferCreateInfo vk2dInitFramebufferCreateInfo(VkRenderPass renderPass,
...
VkPresentInfoKHR
vk2dInitPresentInfoKHR(VkSwapchainKHR *swapchains, uint32_t swapchainCount,
                       uint32_t *images, VkResult *presentResult,
                       VkSemaphore *waitSemaphores, uint32_t semaphoreCount) {
...
VkRenderPassBeginInfo vk2dInitRenderPassBeginInfo(VkRenderPass renderPass,
...
VkShaderModuleCreateInfo vk2dInitShaderModuleCreateInfo(char *code,
                                                        uint32_t codeSize) {
...
vk2dInitPipelineShaderStageCreateInfo(VkShaderStageFlagBits stage,
...
VkPipelineVertexInputStateCreateInfo vk2dInitPipelineVertexInputStateCreateInfo(
...
vk2dInitPipelineInputAssemblyStateCreateInfo(bool triangles) {
...
vk2dInitPipelineViewportStateCreateInfo(VkViewport *viewport,
                                        VkRect2D *scissor) {
...
vk2dInitPipelineMultisampleStateCreateInfo(VkSampleCountFlagBits samples) {
...
vk2dInitPipelineDepthStencilStateCreateInfo() {
...
VkPipelineColorBlendStateCreateInfo vk2dInitPipelineColorBlendStateCreateInfo(
...
vk2dInitPipelineDynamicStateCreateInfo(VkDynamicState *states,
                                       uint32_t stateCount) {
...
VkPipelineLayoutCreateInfo vk2dInitPipelineLayoutCreateInfo(
    VkDescriptorSetLayout *layouts, uint32_t layoutCount,
    uint32_t pushConstantCount, VkPushConstantRange *pushConstants) {
...
VkGraphicsPipelineCreateInfo vk2dInitGraphicsPipelineCreateInfo(
    VkPipelineShaderStageCreateInfo *shaderStages, uint32_t stageCount,
...
vk2dInitVertexInputBindingDescription(VkVertexInputRate input, uint32_t stride,
                                      uint32_t binding) {
...
vk2dInitVertexInputAttributeDescription(uint32_t location, uint32_t binding,
...
VkBufferCreateInfo vk2dInitBufferCreateInfo(VkDeviceSize size,
...
VkDescriptorSetLayoutBinding vk2dInitDescriptorSetLayoutBinding(
    uint32_t binding, VkDescriptorType types, uint32_t typeCount,
    VkShaderStageFlags shaderStage, VkSampler *samplers) {
...
vk2dInitDescriptorSetLayoutCreateInfo(VkDescriptorSetLayoutBinding *bindings,
...
vk2dInitDescriptorPoolCreateInfo(VkDescriptorPoolSize *sizes,
                                 uint32_t poolCount, uint32_t maxSets) {
...
vk2dInitDescriptorSetAllocateInfo(VkDescriptorPool pool, uint32_t amount,
...
VkSamplerCreateInfo vk2dInitSamplerCreateInfo(VkBool32 linearFilter,
                                              float anisotropy,
                                              float mipLevels) {
...
VkWriteDescriptorSet vk2dInitWriteDescriptorSet(VkDescriptorType type,
                                                uint32_t binding,
...
vk2dInitCommandBufferInheritanceInfo(VkRenderPass renderPass, uint32_t subpass,
                                     VkFramebuffer framebuffer) {
