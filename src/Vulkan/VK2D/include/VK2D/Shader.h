...
/// \param uniformBufferSize Size of the shader's expected uniform buffer (0 is
/// valid)
/// \return Returns a new shader or NULL
/// \warning There are strict requirements for how the shader should be
/// constructed
/// \warning uniformBufferSize must be less than the `maxShaderBufferSize` field
/// of `vk2dRendererGetLimits`
/// \warning uniformBufferSize must be a multiple of 4
///
/// Check the shaders shaders/tex.vert and shaders/tex.frag for information on
/// how the shaders should be set up. You may choose to not include a uniform
/// buffer if you specify a uniform buffer size of 0.
VK2DShader vk2dShaderLoad(const char *vertexShader, const char *fragmentShader,
                          uint32_t uniformBufferSize);

/// \brief Creates a shader you can use to render textures from an in-memory
/// buffer
...
/// \param fragmentShaderBuffer File containing the compiled SPIR-V fragment
/// shader
/// \param fragmentShaderBufferSize Size of the fragmentShaderBuffer buffer in
/// bytes
/// \param uniformBufferSize Size of the shader's expected uniform buffer (0 is
/// valid)
/// \return Returns a new shader or NULL
